...
| [한국 금리 브리핑](docs/features/korean-interest-rate-briefing.md) | `korean-interest-rate-briefing` | 오늘의 국고채 금리, 기간별 변화, 장단기 금리차, 기준금리와의 차이 및 출처 있는 시장 배경을 한 번에 정리 (로그인·API 키 불필요) |
