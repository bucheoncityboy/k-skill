...
| [국고채 수익률곡선 모니터](docs/features/yield-curve-monitor.md) | `yield-curve-monitor` | ECOS 국고채 2·3·5·10·20·30년을 공통 관측일로 정렬해 변화·스프레드·커브 분류·기준금리 갭과 재현 가능한 보고서 생성 (로그인·API 키 불필요) |
