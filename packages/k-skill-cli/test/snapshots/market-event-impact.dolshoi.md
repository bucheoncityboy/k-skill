# market-event-impact — assembled instructions
...
- Execute bundled helpers only through `npx -y @nomadamas/k-skill@0 exec market-event-impact scripts/<file> -- <args>`; do not assume a repository-relative or installed-skill-relative path.
